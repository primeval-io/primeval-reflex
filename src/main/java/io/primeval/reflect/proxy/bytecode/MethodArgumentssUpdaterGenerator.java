...
public final class MethodArgumentssUpdaterGenerator implements Opcodes {
    ...
    public static byte[] generateMethodArgsUpdater(Class<?> classToProxy, Method method, int methodId) throws Exception {
        ...
        cw.visit(52, ACC_PUBLIC + ACC_FINAL + ACC_SUPER, selfClassInternalName, null, "java/lang/Object",
                new String[] {  "io/primeval/reflect/arguments/ArgumentsUpdater" });
    ...
    private static void generateUpdateMethod(ClassWriter cw, String selfClassInternalName, String selfClassDescriptor,
        ...
        MethodVisitor mv;
        mv = cw.visitMethod(ACC_PUBLIC, "update", "()Lio/primeval/reflect/arguments/Arguments;", null, null);
        mv.visitCode();
        Label l0 = new Label();
        mv.visitLabel(l0);
    ...
    private static void generateArgumentSetters(ClassWriter cw, String selfClassInternalName, String selfClassDescriptor,
        ...
        MethodVisitor mv;
        {
            mv = cw.visitMethod(ACC_PUBLIC, "setObjectArg",
                    "(Ljava/lang/String;Ljava/lang/Object;)Lio/primeval/reflect/arguments/ArgumentsUpdater;",
        ...
        }
        {
            mv = cw.visitMethod(ACC_PUBLIC, "setIntArg",
                    "(Ljava/lang/String;I)Lio/primeval/reflect/arguments/ArgumentsUpdater;", null, null);
        ...
        }
        {
            mv = cw.visitMethod(ACC_PUBLIC, "setShortArg",
                    "(Ljava/lang/String;S)Lio/primeval/reflect/arguments/ArgumentsUpdater;", null, null);
        ...
        }
        {
            mv = cw.visitMethod(ACC_PUBLIC, "setLongArg",
                    "(Ljava/lang/String;J)Lio/primeval/reflect/arguments/ArgumentsUpdater;", null, null);
        ...
        }
        {
            mv = cw.visitMethod(ACC_PUBLIC, "setByteArg",
                    "(Ljava/lang/String;B)Lio/primeval/reflect/arguments/ArgumentsUpdater;", null, null);
        ...
        }
        {
            mv = cw.visitMethod(ACC_PUBLIC, "setBooleanArg",
                    "(Ljava/lang/String;Z)Lio/primeval/reflect/arguments/ArgumentsUpdater;", null, null);
        ...
        }
        {
            mv = cw.visitMethod(ACC_PUBLIC, "setFloatArg",
                    "(Ljava/lang/String;F)Lio/primeval/reflect/arguments/ArgumentsUpdater;", null, null);
        ...
        }
        {
            mv = cw.visitMethod(ACC_PUBLIC, "setDoubleArg",
                    "(Ljava/lang/String;D)Lio/primeval/reflect/arguments/ArgumentsUpdater;", null, null);
        ...
        }
        {
            mv = cw.visitMethod(ACC_PUBLIC, "setCharArg",
                    "(Ljava/lang/String;C)Lio/primeval/reflect/arguments/ArgumentsUpdater;", null, null);
