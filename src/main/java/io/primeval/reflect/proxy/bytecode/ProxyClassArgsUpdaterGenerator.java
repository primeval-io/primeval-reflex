...
public final class ProxyClassArgsUpdaterGenerator implements Opcodes {
    ...
    public static byte[] generateMethodArgsUpdater(Class<?> wovenParentClass, Method method, int methodId) throws Exception {
        ...
        String argsClassInternalName = wovenClassInternalName + ProxyClassMethodArgsGenerator.SUFFIX_START + method.getName() + methodId;
