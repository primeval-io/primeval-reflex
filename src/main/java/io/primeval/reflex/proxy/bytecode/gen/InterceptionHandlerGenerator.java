...
public final class InterceptionHandlerGenerator implements Opcodes {
    ...
    public static byte[] generateMethodInterceptionHandler(Class<?> classToProxy, Method method,
        ...
        {
            mv = cw.visitMethod(ACC_PUBLIC, "getArguments", "()Lio/primeval/reflex/arguments/Arguments;", null,
                    null);
            mv.visitCode();
            Label l0 = new Label();
            mv.visitLabel(l0);
            if (parameters.length == 0) {
                mv.visitFieldInsn(GETSTATIC, "io/primeval/reflex/arguments/Arguments", "EMPTY_ARGUMENTS",
                        "Lio/primeval/reflex/arguments/Arguments;");
            } else {
                mv.visitVarInsn(ALOAD, 0);
...

        {
            ...
            mv = cw.visitMethod(ACC_PUBLIC, "invoke",
                    "(Lio/primeval/reflex/arguments/Arguments;)" + invokeReturnTypeDescriptor, null,
            ...
            if (parameters.length == 0) {
                ...
                mv.visitLocalVariable("this", selfClassDescriptor, null, l0,
                        l1, 0);
                mv.visitLocalVariable("arguments", "Lio/primeval/reflex/arguments/Arguments;", null, l0, l1, 1);
            } else {
                ...
                for (int i = 0; i < parameters.length; i++) {
                    ...
                    mv.visitMethodInsn(INVOKEINTERFACE, "io/primeval/reflex/arguments/Arguments",
                ...
                mv.visitLocalVariable("this", selfClassDescriptor, null, l0, l4,
                        0);
                mv.visitLocalVariable("arguments", "Lio/primeval/reflex/arguments/Arguments;", null, l0, l4, 1);
