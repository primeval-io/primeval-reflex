...
import static io.primeval.reflex.proxy.bytecode.gen.BytecodeGenUtils.IRETURN_TYPES;
import static io.primeval.reflex.proxy.bytecode.gen.BytecodeGenUtils.getLoadCode;
import static io.primeval.reflex.proxy.bytecode.gen.BytecodeGenUtils.getReturnCode;
import static io.primeval.reflex.proxy.bytecode.gen.BytecodeGenUtils.getTypeSize;
    ...
    private static void generateArgumentSetters(ClassWriter cw, String selfClassInternalName, String selfClassDescriptor,
        ...
        MethodVisitor mv;
        {
            mv = cw.visitMethod(ACC_PUBLIC, "setObjectArg",
                    "(Ljava/lang/String;Ljava/lang/Object;)Lio/primeval/reflex/arguments/ArgumentsUpdater;",
        ...
        }
        {
            mv = cw.visitMethod(ACC_PUBLIC, "setIntArg",
                    "(Ljava/lang/String;I)Lio/primeval/reflex/arguments/ArgumentsUpdater;", null, null);
        ...
        }
        {
            mv = cw.visitMethod(ACC_PUBLIC, "setShortArg",
                    "(Ljava/lang/String;S)Lio/primeval/reflex/arguments/ArgumentsUpdater;", null, null);
        ...
        }
        {
            mv = cw.visitMethod(ACC_PUBLIC, "setLongArg",
                    "(Ljava/lang/String;J)Lio/primeval/reflex/arguments/ArgumentsUpdater;", null, null);
        ...
        }
        {
            mv = cw.visitMethod(ACC_PUBLIC, "setByteArg",
                    "(Ljava/lang/String;B)Lio/primeval/reflex/arguments/ArgumentsUpdater;", null, null);
        ...
        }
        {
            mv = cw.visitMethod(ACC_PUBLIC, "setBooleanArg",
                    "(Ljava/lang/String;Z)Lio/primeval/reflex/arguments/ArgumentsUpdater;", null, null);
        ...
        }
        {
            mv = cw.visitMethod(ACC_PUBLIC, "setFloatArg",
                    "(Ljava/lang/String;F)Lio/primeval/reflex/arguments/ArgumentsUpdater;", null, null);
        ...
        }
        {
            mv = cw.visitMethod(ACC_PUBLIC, "setDoubleArg",
                    "(Ljava/lang/String;D)Lio/primeval/reflex/arguments/ArgumentsUpdater;", null, null);
        ...
        }
        {
            mv = cw.visitMethod(ACC_PUBLIC, "setCharArg",
                    "(Ljava/lang/String;C)Lio/primeval/reflex/arguments/ArgumentsUpdater;", null, null);
